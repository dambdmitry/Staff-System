...
import edu.prctice.staff.exceptions.NotFoundDepartmentException;
import edu.prctice.staff.exceptions.NotFoundOrderException;
import edu.prctice.staff.exceptions.NotFoundWorkerException;
...
@Component
public class OrganizationTables implements OrganizationTablesManagment {
    @Autowired
